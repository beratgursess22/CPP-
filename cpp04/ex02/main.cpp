...
/*   Updated: 2025/11/18 21:30:27 by igurses          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    std::cout << "\n====== Coppy Assisment ======\n" << std::endl;
    copy = original;
    std::cout << "Original Brain address: " << original.getBrain()<<" İdea[0]: " << original.getBrain()->getIdea(0) <<std::endl;
    std::cout << "Copy Brain address: " << copy.getBrain()<< " idea[0] "<< copy.getBrain()->getIdea(0) << std::endl;
